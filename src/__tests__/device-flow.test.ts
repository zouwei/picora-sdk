 ...
 *
 * 覆盖（10 case）：
 *   D1 startDeviceFlow POST /oauth/device_authorization with form body
...
import { startDeviceFlow, MemoryTokenStorage } from '../device-flow'
...
describe('v0.61.10 — Device Flow', () => {
  it('D1: startDeviceFlow POSTs form body to /oauth/device_authorization', async () => {
    ...
    expect(String(call?.[0])).toContain('/oauth/device_authorization')
